...
const restaurants = [
  ...
  },
  {
    ...
    title: "Sushi House",
    description:
      "Serving delicious sushi rolls and authentic Japanese cuisine.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Fresh seafood dishes made to order with a great view of the ocean.",
  },
  {
    id: 7,
    title: "Thai Kitchen",
    description:
      "Authentic Thai dishes made with fresh ingredients and spices.",
  },
  {
    id: 8,
    title: "Pizza Palace",
    description:
      "Delicious pizzas with a variety of toppings and crust options.",
  },
  {
    id: 9,
    title: "Indian Cuisine",
    description:
      "Traditional Indian dishes made with authentic spices and flavors.",
  },
  {
    id: 10,
    title: "Vegetarian Garden",
    description:
      "Delicious vegetarian and vegan dishes made with fresh ingredients.",
  },
];
...
console.log(await search("witch restaurant has not have a good taco?"));
